...
File and class colp- opens/reads a file, stores in objects of custom class
...
def main():
    ...
    for line in in_file:
        ...
        # Convert reflection and pointer_arithmetic to Boolean
        reflection = parts[2] == "Yes"
        pointer_arithmetic = parts[4] == "Yes"  # New field handling
