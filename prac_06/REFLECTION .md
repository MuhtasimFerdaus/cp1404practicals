...
`
Following the classes, and Ahmed sir's guidance
`
...
`
I Would have suggested more pucharm based work during classes, but as we already have that, so nothing more to suggest at the moment.
`
